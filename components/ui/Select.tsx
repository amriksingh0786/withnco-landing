      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ...
            id={id}
            className={cn(
              "w-full h-14 px-4 pr-10 text-body-sm bg-warm-white dark:bg-dark-surface text-off-black dark:text-warm-white border border-stone/30 dark:border-stone/40 rounded appearance-none cursor-pointer",
